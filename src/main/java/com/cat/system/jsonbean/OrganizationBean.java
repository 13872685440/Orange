...
public class OrganizationBean extends BaseAppBean {
	...
	private String zzlx_code;
	
	private String zzlx_data;
	...
	public static OrganizationBean setThis(Organization entity) {
		...
		bean.setZzlx_code(entity.getZzlx()!=null ? entity.getZzlx().getCode() : "");
		bean.setZzlx_data(entity.getZzlx()!=null ? entity.getZzlx().getName() : "");
	...
	public static void clone(Organization bean, OrganizationBean entity, BaseService baseService) {
		...
		bean.setZzlx((Dictionary) baseService.findById(Dictionary.class, entity.getZzlx_code()));
	}
	...
	public String getZzlx_code() {
		return zzlx_code;
	}

	public void setZzlx_code(String zzlx_code) {
		this.zzlx_code = zzlx_code;
	}

	public String getZzlx_data() {
		return zzlx_data;
	}

	public void setZzlx_data(String zzlx_data) {
		this.zzlx_data = zzlx_data;
	}
}
